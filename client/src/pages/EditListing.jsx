...
const editListingSchema = z.object({
  ...
  images: z
    .instanceof(FileList)
    .refine(
      files => files.length === 0 || files.length <= 3,
...
export default function EditListing() {
  ...
  function onSubmit(data) {
    ...
    requestPayload.append('listingId', listing._id);
    toast.promise(editListingMutation.mutateAsync(requestPayload), {
      ...
      <form
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <p className="text-red-500">
            <span className="font-semibold mr-2">Note:</span>Uploading new
            images will replace the current listing images. If you want to keep
            the existing images, please upload them again together with the new
            images.
          </p>
